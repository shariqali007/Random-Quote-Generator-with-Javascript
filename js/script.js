...
//Using random number for quote index
...
* 
* @returns displayString - The actual Random quote with full available text.
*/
...
displayString += `</p>`
document.getElementById( 'quote-box' ).innerHTML = displayString;
